    ...
    <header className={isMenuOpen ? 'menu-open' : ''}>
      <div className="menu-container">
        ...
        <nav className={isMenuOpen ? 'active' : ''}>
          ...
          <li><a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ&ab_channel=RickAstley">Documentation </a></li>
            <li>
              <a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ&ab_channel=RickAstley" className="special-button" onClick={toggleMenu}>
                Index Products
